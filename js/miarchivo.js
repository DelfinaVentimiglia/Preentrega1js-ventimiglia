/* 
* Sistema de turnos para psicologos*
...
let bienvenido = confirm("Bienvenido a sistema de turnos para sesiones psicologicas. Desea comenzar?")
const personas = [];
const turno_agenda = [];
...
let gracias =confirm("Gracias por reservar un turno con nosotros!")
...
// muestro informacion de los usuarios
